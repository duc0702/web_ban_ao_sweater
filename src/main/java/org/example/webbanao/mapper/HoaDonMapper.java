...
import org.example.webbanao.entity.KhachHang;
import org.example.webbanao.entity.NhanVien;
...
public interface HoaDonMapper {
    ...
    HoaDon toHoaDon(HoaDonCreateRequest request);
    ...
    @Mapping(target = "tenKhachHang", expression = "java(hoaDon.getKhachHang() != null ? hoaDon.getKhachHang().getTenKhachHang() : hoaDon.getTenKhachHang())")
