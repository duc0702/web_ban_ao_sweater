...
{
    type: "collapse",
    name: "Quản Lý Đơn Hàng", // Tên hiển thị trên menu
    key: "order-management",   // Key định danh, không trùng lặp
    route: "/quan-ly-don-hang", // Đường dẫn bạn muốn
    icon: <Document size="12px" />, // Icon hiển thị
    component: <OrderManagementPage />, // Component của bạn
    noCollapse: true,
  },
  {
